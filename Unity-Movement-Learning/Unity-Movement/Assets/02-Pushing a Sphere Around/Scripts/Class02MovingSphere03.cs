...
public class Class02MovingSphere03 : MonoBehaviour
{
    ...
    int groundContactCount;     // 接触点计数

    bool desiredJump;   // 是否跳跃
    bool onGround { get { return groundContactCount > 0; } }      // 是否处于地面
    ...
    private void EvaluateCollision (Collision collision)
    {
        for (int i = 0; i < collision.contactCount; i++)
        {
            ...
            if (normal.y >= minGroundDotProduct)
            {
                ...
                contactNormal += normal;    // 更改为累积法线 而不是覆盖
            }
        }
    }
