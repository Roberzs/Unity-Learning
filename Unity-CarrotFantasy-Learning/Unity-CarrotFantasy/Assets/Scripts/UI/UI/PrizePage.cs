...
public class PrizePage : MonoBehaviour 
{
    ...
    private void Awake()
    {
        ...
        img_Prize = transform.Find("Img_BG").transform.Find("Img_Prize").GetComponent<Image>();
        img_Instruction = transform.Find("Img_BG").transform.Find("Img_instruction").GetComponent<Image>();
        txt_PrizeName = transform.Find("Img_BG").transform.Find("Txt_PrizeName").GetComponent<Text>();
    }
    ...
    {
        normalModelPanel.ShowPrizePage(false);
